...
from app.services.sector_ministry_service import generate_analytics
...
@sector_ministry_bp.get("/sector-ministry/analytics")
def sector_ministry_analytics():
    try:
        view_by = request.args.get("view_by", "sector")
        ministry = request.args.get("ministry", "All Ministries")
        sector = request.args.get("sector", "All Sectors")
